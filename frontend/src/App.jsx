      ...
      <div className="relative z-10 flex min-h-full items-center justify-center px-4">
        <div className="w-full max-w-lg text-center">
          <div className="flex flex-col items-center justify-center">
            <img src={logo} alt="MP Police Logo" className="mb-6 h-24 w-24 rounded-full object-cover shadow-2xl boot-logo-pulse" />
      ...
      <div className="flex min-h-screen">
        <aside className="hidden w-72 flex-col border-r border-slate-200 bg-slate-100 px-4 py-6 lg:flex">
          <div className="mb-8 px-2 flex items-center gap-3">
            <img src={logo} alt="MP Police Logo" className="h-12 w-12 rounded-full object-cover border-2 border-slate-200" />
            <div>
